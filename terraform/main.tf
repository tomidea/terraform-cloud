resource "aws_s3_bucket" "terraform_state" {
  bucket = "aremac-terraform-bucket"
...
module "ALB" {
  ...
  public-sbnt-1      = module.VPC.public_subnets-1
  public-sbnt-2      = module.VPC.public_subnets-2
  private-sbnt-1     = module.VPC.private_subnets-1
  private-sbnt-2     = module.VPC.private_subnets-2
...
module "AutoScaling" {
  ...
  public-sbnts      = [module.VPC.public_subnets-1, module.VPC.public_subnets-2]
  private-sbnts     = [module.VPC.private_subnets-1, module.VPC.private_subnets-2]
  keypair           = var.keypair
